...
class TunerTestForWebAndMobileWidget extends StatefulWidget {
  const TunerTestForWebAndMobileWidget({super.key, this.width, this.height});

  final double? width;
  final double? height;

  @override
  _TunerTestForWebAndMobileWidgetState createState() =>
      _TunerTestForWebAndMobileWidgetState();
}

class _TunerTestForWebAndMobileWidgetState
    extends State<TunerTestForWebAndMobileWidget> {
  // كاشف درجة الصوت
  ...
  bool _hasEnoughDataForAnalysis() {
    final minBufferSizeSamples =
        (_sampleRate * _minBufferSizeMs / 1000).round();
